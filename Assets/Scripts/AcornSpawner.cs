...
public class AcornSpawner : MonoBehaviour
{
    ...
    private void CheckHeight(float xCoordinate )
    {
        Physics.SphereCast(new Vector3(xCoordinate, transform.position.y, transform.position.z), 2f, Vector3.down, out RaycastHit hitInfo, 10);
